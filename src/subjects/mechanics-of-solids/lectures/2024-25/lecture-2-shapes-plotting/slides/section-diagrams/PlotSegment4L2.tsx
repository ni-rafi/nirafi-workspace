...
export const PlotSegment4L2: React.FC = () => {
  ...
  return (
    <FullWidthLayout
      title={<span>Plotting Diagrams - Segment 4</span>}
    >
      <div className="w-full h-full grid grid-cols-1 lg:grid-cols-12 gap-4 items-stretch select-none animate-in fade-in duration-300 text-left">
        ...
        <div className="lg:col-span-7 flex flex-col items-center justify-center p-3 border border-border/50 bg-muted/20 dark:bg-slate-900/10 rounded-xl min-h-[300px]">
          <svg className="w-full max-w-[460px] h-[250px] overflow-visible" viewBox="0 0 460 250">
            ...
            <g>
              <path
                d={`M 50,60 L 50,35 L 140,35 L 266,72 L 356,72`}
                fill="none"
              ...
              <circle cx="356" cy="72" r="3" className="fill-rose-500 stroke-white dark:stroke-slate-900" strokeWidth="1" />
              {step >= 2 && (
                <>
                  <circle cx="356" cy="98" r="3" className="fill-rose-500 stroke-white dark:stroke-slate-900 animate-in zoom-in-50 duration-200" strokeWidth="1" />
                  <circle cx="410" cy="98" r="3" className="fill-rose-500 stroke-white dark:stroke-slate-900 animate-in zoom-in-50 duration-200" strokeWidth="1" />
                </>
              )}
              {step >= 3 && <text x="383" y="109" textAnchor="middle" className="text-[8px] font-bold fill-rose-600 dark:fill-rose-400 font-mono animate-in fade-in duration-300">-21.68 kN</text>}
            ...
            <g>
              ...
              <line x1="266" y1="125" x2="356" y2="144" className="stroke-indigo-500/60" strokeWidth="2.5" strokeLinecap="round" />
              <motion.line
                x1={356}
                y1={144}
                x2={410}
              ...
              {step >= 2 && (
                <circle cx="410" cy="180" r="3" className="fill-indigo-500 stroke-white dark:stroke-slate-900 animate-in zoom-in-50 duration-200" strokeWidth="1" />
              )}
              {step >= 3 && (
                <text x="410" y="191" textAnchor="middle" className="text-[8px] font-bold fill-indigo-600 dark:fill-indigo-400 font-mono animate-in fade-in duration-300">0</text>
              )}
        ...
        <div className="lg:col-span-5 flex flex-col justify-between gap-3 text-left">
          <div>
            ...
            <h3 className="text-base font-bold text-foreground">Segment 4 (17 to 20 m)</h3>
          ...
          <div className="space-y-2.5 flex-1 flex flex-col justify-center">
            ...
            <InteractiveCard className="p-3 border-l-4 border-l-rose-500 bg-rose-50/20 dark:bg-rose-950/5 space-y-1">
              ...
              <div className="text-xs font-mono font-bold text-foreground">
                <LatexFormula math="V(x) = -21.675\text{ kN}" />
              </div>
              <ClickReveal at={1}>
              ...
              <ClickReveal at={2}>
                <div className="text-[10px] font-mono text-rose-600 dark:text-rose-400 font-semibold pt-1 border-t border-rose-500/10">
                  <LatexFormula math="V(17) = -21.68\text{ kN}, \quad V(20) = -21.68\text{ kN}" />
                </div>
              </ClickReveal>
            </InteractiveCard>
            ...
            <InteractiveCard className="p-3 border-l-4 border-l-indigo-500 bg-indigo-50/20 dark:bg-indigo-950/5 space-y-1">
              ...
              <div className="text-xs font-mono font-bold text-foreground">
                <LatexFormula math="M(x) = 65.05 - 21.675(x - 17)\text{ kNm}" />
              </div>
              <ClickReveal at={1}>
                <p className="text-[10px] text-muted-foreground leading-snug">
              ...
              <ClickReveal at={2}>
                <div className="text-[10px] font-mono text-indigo-600 dark:text-indigo-400 font-semibold pt-1 border-t border-indigo-500/10">
                  <LatexFormula math="M(17) = +65.05\text{ kNm}, \quad M(20) = 0" />
                </div>
              </ClickReveal>
            </InteractiveCard>
          </div>
