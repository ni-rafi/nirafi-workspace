        ...
        <div className="flex-1 grid grid-cols-1 md:grid-cols-2 gap-3 mt-1">
          ...
          <InteractiveCard spacing="space-y-1" className="py-1.5 px-2.5 border-l-4 border-l-indigo-500 bg-muted/10">
            ...
            <div className="grid grid-cols-3 gap-1.5 text-[9.5px] py-1 border-b border-border/10 font-mono text-center items-stretch">
              <div className={`p-1 rounded-lg border transition-all duration-300 flex flex-col justify-between ${step === 2
              ...
              <div className={`p-1 rounded-lg border transition-all duration-300 flex flex-col justify-between ${(step === 1 || step === 2)
              ...
              <div className={`p-1 rounded-lg border transition-all duration-300 flex flex-col justify-between ${step === 1
          ...
          <InteractiveCard spacing="space-y-1" className="py-1.5 px-2.5 border-l-4 border-l-rose-500 bg-muted/10">
            ...
            <div className="grid grid-cols-3 gap-1.5 text-[9.5px] py-1 border-b border-border/10 font-mono text-center items-stretch">
              <div className={`p-1 rounded-lg border transition-all duration-300 flex flex-col justify-between ${step === 4
                ? 'bg-rose-500/15 text-rose-700 dark:text-rose-300 border-rose-500/25 font-bold scale-[1.02]'
                : 'border-transparent text-muted-foreground'
                }`}>
                <span className="text-[7.5px] uppercase tracking-wider block opacity-80 mb-0.5">Load w(x)</span>
              ...
              <div className={`p-1 rounded-lg border transition-all duration-300 flex flex-col justify-between ${(step === 3 || step === 4)
              ...
              <div className={`p-1 rounded-lg border transition-all duration-300 flex flex-col justify-between ${step === 3
                ? 'bg-indigo-500/15 text-indigo-700 dark:text-indigo-300 border-indigo-500/25 font-bold scale-[1.02]'
                : 'border-transparent text-muted-foreground'
                }`}>
                <span className="text-[7.5px] uppercase tracking-wider block opacity-80 mb-0.5">Moment M(x)</span>
          ...
          <InteractiveCard spacing="space-y-1" className="py-1.5 px-2.5 border-l-4 border-l-emerald-500 bg-muted/10">
            ...
            <div className="grid grid-cols-3 gap-1.5 text-[9.5px] py-1 border-b border-border/10 font-mono text-center items-stretch">
              <div className={`p-1 rounded-lg border transition-all duration-300 flex flex-col justify-between ${step === 6
                ? 'bg-rose-500/15 text-rose-700 dark:text-rose-300 border-rose-500/25 font-bold scale-[1.02]'
                : 'border-transparent text-muted-foreground'
                }`}>
                <span className="text-[7.5px] uppercase tracking-wider block opacity-80 mb-0.5">Load w(x)</span>
              ...
              <div className={`p-1 rounded-lg border transition-all duration-300 flex flex-col justify-between ${(step === 5 || step === 6)
              ...
              <div className={`p-1 rounded-lg border transition-all duration-300 flex flex-col justify-between ${step === 5
                ? 'bg-indigo-500/15 text-indigo-700 dark:text-indigo-300 border-indigo-500/25 font-bold scale-[1.02]'
                : 'border-transparent text-muted-foreground'
                }`}>
                <span className="text-[7.5px] uppercase tracking-wider block opacity-80 mb-0.5">Moment M(x)</span>
          ...
          <InteractiveCard spacing="space-y-1" className="py-1.5 px-2.5 border-l-4 border-l-amber-500 bg-muted/10">
            ...
            <div className="grid grid-cols-3 gap-1.5 text-[9.5px] py-1 border-b border-border/10 font-mono text-center items-stretch">
              <div className={`p-1 rounded-lg border transition-all duration-300 flex flex-col justify-between ${step === 8
                ? 'bg-rose-500/15 text-rose-700 dark:text-rose-300 border-rose-500/25 font-bold scale-[1.02]'
                : 'border-transparent text-muted-foreground'
                }`}>
                <span className="text-[7.5px] uppercase tracking-wider block opacity-80 mb-0.5">Load w(x)</span>
              ...
              <div className={`p-1 rounded-lg border transition-all duration-300 flex flex-col justify-between ${(step === 7 || step === 8)
              ...
              <div className={`p-1 rounded-lg border transition-all duration-300 flex flex-col justify-between ${step === 7
                ? 'bg-indigo-500/15 text-indigo-700 dark:text-indigo-300 border-indigo-500/25 font-bold scale-[1.02]'
                : 'border-transparent text-muted-foreground'
                }`}>
                <span className="text-[7.5px] uppercase tracking-wider block opacity-80 mb-0.5">Moment M(x)</span>
