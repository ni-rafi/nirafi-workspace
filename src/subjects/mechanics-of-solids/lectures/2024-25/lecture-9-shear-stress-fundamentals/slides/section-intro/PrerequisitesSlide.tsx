...
export const PrerequisitesSlide: React.FC = () => {
  const prerequisiteItems = [
    { title: 'Shear Force & SFDs', text: 'Calculating internal shear force (V) at any segment section and plotting SFDs.' },
    { title: 'Moment of Inertia (I)', text: 'Calculating second moment of area for rectangular and symmetric profiles.' },
    { title: 'Centroid & Neutral Axis (N.A.)', text: 'Locating the centroid of a cross-section to establish the zero bending stress plane.' },
    { title: 'Equilibrium Equations', text: 'Applying sum of forces and moments to satisfy overall static structural stability.' }
  ];
