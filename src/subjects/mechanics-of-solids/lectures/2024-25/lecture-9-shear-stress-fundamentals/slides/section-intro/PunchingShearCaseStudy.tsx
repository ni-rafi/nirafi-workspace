    ...
    <TwoColumnLayout
      ...
      leftContent={
        <div className="flex flex-col h-full justify-between gap-3 text-left">
          ...
          <div className="border border-border/30 bg-muted/10 rounded-2xl p-4 flex items-center justify-center flex-1 min-h-[160px]">
          ...
          <SlideCallout variant="danger" className="py-2 px-3">
            <strong className="text-red-500 block text-xs">Brittle Failure Mode:</strong> Unlike bending failures which show visible sagging warning signs, shear failures occur instantaneously with zero deflection warning.
          </SlideCallout>
        </div>
      }
      rightContent={
        <div className="flex flex-col h-full justify-between items-center bg-muted/20 border border-border/40 rounded-2xl p-4 min-h-[260px]">
          <div className="relative w-full flex-1 rounded-xl overflow-hidden shadow-md flex items-center justify-center bg-black/10 max-h-[190px]">
            <img
              src={collapseImg}
