...
export const Lecture5References: React.FC = () => {
  ...
  return (
    <ReferencesLayout
      ...
      instruction="Refer to these textbooks and sections to study shear force and bending moment distributions."
    />
  );
};

export default Lecture5References;
