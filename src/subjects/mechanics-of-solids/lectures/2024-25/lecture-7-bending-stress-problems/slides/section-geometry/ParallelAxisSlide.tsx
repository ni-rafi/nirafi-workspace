        ...
        <div className="flex flex-col h-full justify-between gap-4 text-left select-text">
          <div>
            ...
            <SlideParagraph variant="plain" className="text-xs text-muted-foreground leading-relaxed">
              When an area does not align with the target bending axis, we must project its centroidal inertia across a distance $d$.
            </SlideParagraph>
          </div>
          <div className="space-y-2 my-2">
            <SlideBullet text="I_xx represents the moment of inertia about the shape's own centroidal axis." />
            <SlideBullet text="d is the perpendicular distance from the centroidal axis to the new parallel reference axis x'." />
            <SlideBullet text="A * d² represents the transfer term, reinforcing that resistance scales quadratically with distance." />
          </div>
          <div className="my-2">
